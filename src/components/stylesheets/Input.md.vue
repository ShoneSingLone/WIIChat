<template>
  <transition :name="transitionName">
    <div class="wrapper" data-wow-delay="0.5s">
      <input :type="type" class="input" :id="forNameId" :name="forNameId">
      <label class="form__label" :for="forNameId">
        <span class="form__label__content">{{labelOptions.text}}</span>
      </label>
    </div>
  </transition>
</template>
...
.wrapper {
  ...
  background-color: rgba(31, 114, 187, 0.596);
  .input {
    outline: 0;
