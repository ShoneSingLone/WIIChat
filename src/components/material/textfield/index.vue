<template>
    <div class="mdc-text-field">
        <slot></slot>
        <input type="text" class="mdc-text-field__input mdc-text-field--outlined">
...
.mdc-text-field {
  ...
  @include mdc-text-field-hover-bottom-line-color(
    $mdc-text-field-bottom-line-hover
  );
...
@include mdc-floating-label-shake-keyframes(
  text-field-box,
  $mdc-text-field-box-label-position-y
);
@include mdc-floating-label-shake-keyframes(
  text-field-box-dense,
  $mdc-text-field-box-dense-label-position-y,
  0%,
...
@include mdc-floating-label-shake-keyframes(
  textarea,
  $mdc-text-field-textarea-label-position-y,
  0%,
  $mdc-text-field-textarea-label-scale
);
</style>
